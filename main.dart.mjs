...
_1589: () => new AudioContext(),
_1590: (x0,x1) => x0.createMediaElementSource(x1),
_1591: x0 => x0.createStereoPanner(),
_1592: (x0,x1) => x0.connect(x1),
_1593: x0 => x0.load(),
_1594: x0 => x0.remove(),
_1595: x0 => x0.play(),
_1596: x0 => x0.pause(),
...
_1642: (decoder, codeUnits) => decoder.decode(codeUnits),
_1643: () => new TextDecoder("utf-8", {fatal: true}),
_1644: () => new TextDecoder("utf-8", {fatal: false}),
_1645: v => v.toString(),
_1646: (d, digits) => d.toFixed(digits),
_1650: x0 => new WeakRef(x0),
_1651: x0 => x0.deref(),
_1657: Date.now,
_1659: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1660: s => {
...
_1662: () => typeof dartUseDateNowForTicks !== "undefined",
_1663: () => 1000 * performance.now(),
_1664: () => Date.now(),
_1667: () => new WeakMap(),
_1668: (map, o) => map.get(o),
_1669: (map, o, v) => map.set(o, v),
_1670: () => globalThis.WeakRef,
_1681: s => JSON.stringify(s),
_1682: s => printToConsole(s),
_1683: a => a.join(''),
_1686: (s, t) => s.split(t),
_1687: s => s.toLowerCase(),
_1688: s => s.toUpperCase(),
_1689: s => s.trim(),
_1690: s => s.trimLeft(),
_1691: s => s.trimRight(),
_1693: (s, p, i) => s.indexOf(p, i),
_1694: (s, p, i) => s.lastIndexOf(p, i),
_1696: Object.is,
_1697: s => s.toUpperCase(),
_1698: s => s.toLowerCase(),
_1699: (a, i) => a.push(i),
_1703: a => a.pop(),
_1704: (a, i) => a.splice(i, 1),
_1706: (a, s) => a.join(s),
_1707: (a, s, e) => a.slice(s, e),
_1710: a => a.length,
_1712: (a, i) => a[i],
_1713: (a, i, v) => a[i] = v,
_1715: (o, offsetInBytes, lengthInBytes) => {
...
_1786: (x0,x1) => x0.createElement(x1),
_1789: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1789(f,arguments.length,x0) }),
_1791: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1792: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1814: (s, m) => {
          try {
...
_2656: (x0,x1) => x0.crossOrigin = x1,
_2659: (x0,x1) => x0.preload = x1,
_2663: x0 => x0.currentTime,
_2664: (x0,x1) => x0.currentTime = x1,
_2665: x0 => x0.duration,
_2670: (x0,x1) => x0.playbackRate = x1,
_2679: (x0,x1) => x0.loop = x1,
_2683: (x0,x1) => x0.volume = x1,
_2700: x0 => x0.code,
_2701: x0 => x0.message,
_5909: x0 => x0.destination,
_6557: () => globalThis.document
    };
